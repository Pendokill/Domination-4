...
vehicleShop_manualVehicles = [
	...
	["I_MRAP_03_hmg_F", 200, "Страйдер (Пулемёт)", 0],
	["I_MRAP_03_gmg_F", 200, "Страйдер (Гранатомёт)", 0],
	["O_MRAP_02_hmg_F", 200, "Ифрит (Пулемёт)", 0],
	["O_MRAP_02_gmg_F", 200, "Ифрит (Гранатомёт)", 0],
	["min_rf_gaz_2330_HMG", 250, "ТИГР-2330", 0],
	["min_rf_gaz_2330_HMG_desert", 250, "ТИГР-2330 (Пустыня)", 0],
	["min_rf_gaz_2330_HMG_winter", 250, "ТИГР-2330 (Зима)", 0],
	["rhs_tigr_sts_3camo_msv", 300, "ТИГР-2330", 0],
    ["rhsgref_BRDM2_ATGM_vmf", 300, "БРДМ-2 (ПТУР)", 1],
	["O_APC_Wheeled_02_rcws_v2_F", 250, "МСЕ-3 Марид", 1],
	["O_APC_Tracked_02_cannon_F", 250, "БТР-К Камыш", 1],
	["rhs_btr80_vdv", 200, "БТР-80 (ВДВ)", 1],
	["rhs_btr80a_vmf", 250, "БТР-80А (МП)", 1],
    ["rhs_bmp1p_vmf", 250, "БМП-1", 2],
	["rhs_brm1k_vmf", 250, "БРМ-1К", 2],
	["rhs_bmp2k_vmf", 300, "БМП-2К", 2],
	["rhs_bmp2_msv", 300, "БМП-2", 2],
	["rhs_bmd2m", 300, "БМД-2М", 2],
	["rhs_bmd4ma_vdv", 350, "БМД-4М (ДБ)", 2],
	...
	["I_MBT_03_cannon_F", 400, "МБТ-52 Кума", 2],
	["rhs_t72be_tv", 450, "Т-72 Б3", 3],
	["FP_Ger_Leopard", 700, "Леопард", 3],
    ["rhs_t80bv", 500, "Т-80БВ", 3],
	["rhs_t80uk", 550, "Т-80УК", 3],
    ["FP_Chechen_T80", 500, "Т-80", 3],
	["rhs_t90am_tv", 600, "Т-90АМ", 3],
    ["rhs_t90sm_tv", 600, "Т-90СМ", 3],
	["O_BMPT", 750, "БМПТ Терминатор", 3],
	["min_rf_t_15", 700, "Т-15 Армата", 3],
	["min_rf_t_15_desert", 700, "Т-15 Армата (Пустыня)", 3],
	["min_rf_t_15_winter", 700, "Т-15 Армата (Зима)", 3],
    ["min_rf_t_14", 800, "Т-14 Армата", 3],
	["min_rf_t_14_desert", 800, "Т-14 Армата (Пустыня)", 3],
	["min_rf_t_14_winter", 800, "Т-14 Армата (Зима)", 3],
	["min_rf_su_34", 750, "Су-34", 4],
	["min_rf_su_34_desert", 750, "Су-34", 4],
	["I_Plane_Fighter_03_dynamicLoadout_F", 500, "А-143", 3],
	["O_Plane_CAS_02_dynamicLoadout_F", 650, "То-199 Неофрон", 4],
	["RHS_T50_vvs_blueonblue", 800, "СУ-57", 4],
	["RHS_T50_vvs_generic_ext", 800, "СУ-57 (Внешние пилоны)", 4],
	["RHS_Su25SM_vvsc", 700, "СУ-25 (Камуфляж)", 4],
	["RHS_Su25SM_vvs", 700, "СУ-25 СМ", 4],
	["rhs_mig29s_vvsc", 700, "МИГ-29 С (Камуфляж)", 4],
	["rhs_mig29s_vvs", 700, "МИГ-29 С", 4],
	["rhs_mig29sm_vvsс", 700, "МИГ-29 СМ (Камуфляж)", 4],
	["rhs_mig29sm_vvs", 700, "МИГ-29 СМ", 4],
	["RHS_A10", 700, "A-10A", 4],
	["rhsusf_f22", 800, "F-22A", 4],
	["RHS_TU95MS_vvs_chelyabinsk", 400, "ТУ-95 МС-6", 4],
	["RHS_MELB_AH6M", 200, "АН-6М Литлбёрд (2 пулемёта + 2 малых нурса)", 3],
	["RHS_MELB_AH6M_M", 250, "АН-6М-М Литлбёрд (пулемёт + большой нурс)", 3],
    ["RHS_MELB_AH6M_H", 300, "АН-6М-Н Литлбёрд (пулемёт + 2 ракеты наведения)", 3],
	["RHS_Mi8AMTSh_vvs", 350, "МИ-8 АМТШ", 3],
	["RHS_Mi24V_vvs", 550, "МИ-24 В", 4],
	["rhsgref_cdf_Mi24D", 600, "МИ-24 Д", 4],
	["rhsgref_mi24g_CAS", 650, "МИ-24 Г", 4],
	["FP_Spetsnaz_Alpha_Mi24_Super_Hind", 700, "МИ-24", 4],
...
/*
    Определение иконки мода для техники
    Параметры:
        _className - класс техники
    Возвращает:
        Путь к иконке или пустую строку
*/
vehicleShop_getModIcon = {
    ...
    private _modIcons = [
        ...
        ["scat_", "\scat_units\data\icon_scat_ca.paa"]
    ];
...
vehicleShop_loadVehicles = {
    ...
    switch (vehicleShop_loadMode) do {
        case 0: {
            ...
            // Применяем наценку 20% в авторежиме
        ...
        case 1: {
            ...
            vehicleShop_vehicles = [vehicleShop_vehicles, 10] call vehicleShop_applyPriceMarkup;
        };
    };
