...
// Если какой-либо игрок попадает в радиус действия основной цели, то создайте большую группу пехоты в непосредственной близости от центра главной цели.  Пехота может немедленно выдвигаться.
