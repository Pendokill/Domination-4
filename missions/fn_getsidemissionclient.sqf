...
[true, "d_sm_task", [d_cur_sm_txt, localize "STR_DOM_MISSIONSTRING_710", format ["d_XMISSIONM%1", d_cur_sm_idx + 1]], d_x_sm_pos # 0, false, 1, true, "Attack", false] call d_fnc_taskcreate;
