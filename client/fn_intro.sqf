...
0 = [parseText format [ "<br/><t font='PuristaMedium' align='left' size='2.3'> Приветствуем на Доминация 4!</t><br/>  <t align='left' size='1'>  версия 4.71  </t>"], [safeZoneX + 0.1,safeZoneY + safeZoneH - 0.2,0.9,0.3], nil, 5, 1, 0]  spawn BIS_fnc_textTiles;
...
if (d_WithMHQTeleport == 0) then {
	"d_introtxt2" cutText [format ["<t color='#FF8042' size='2'>%1</t>", localize "STR_DOM_MISSIONSTRING_1988"], "PLAIN DOWN", -1, true, true];
	sleep 10;
};

"d_introtxt2" cutText [format ["<t color='#df3e16' size='1.2'>%1</t>", localize "STR_DOM_MISSIONSTRING_2114"], "PLAIN DOWN", -1, true, true];
