...
if (_score < d_points_needed # 1 && {_score >= d_points_needed # 0 && {_d_player_old_rank != 1}}) exitWith {
	if (player getVariable ["d_player_old_score", 0] < d_points_needed # 1) then {
		if (!isStreamFriendlyUIEnabled && {d_force_isstreamfriendlyui != 1}) then {
			...
			call {hint composeText [localize "STR_NewRank1", parsetext "<br />",localize "STR_Corporal", parsetext "<br /><t><img size='7' align='center' image='pics\2.paa'></t>", parseText "<br />",localize "STR_NewRank1a"];}
		};
		//playSound "d_fanfare";
		playSound "d_rankup";
	} else {
...
if (_score < d_points_needed # 2 && {_score >= d_points_needed # 1 && {_d_player_old_rank != 2}}) exitWith {
	if (player getVariable ["d_player_old_score", 0] < d_points_needed # 2) then {
		if (!isStreamFriendlyUIEnabled && {d_force_isstreamfriendlyui != 1}) then {
			...
			call {hint composeText [localize "STR_NewRank1", parseText "<br />",localize "STR_Sergeant", parsetext "<br /><t><img size='7' align='center' image='pics\3.paa'></t>",parseText "<br />",localize "STR_NewRank2"];}
		};
		//playSound "d_fanfare";
		playSound "d_rankup";
	} else {
...
if (_score < d_points_needed # 3 && {_score >= d_points_needed # 2 && {_d_player_old_rank != 3}}) exitWith {
	if (player getVariable ["d_player_old_score", 0] < d_points_needed # 3) then {
		if (!isStreamFriendlyUIEnabled && {d_force_isstreamfriendlyui != 1}) then {
			...
			call {hint composeText [localize "STR_NewRank1", parsetext "<br />",localize "STR_Lieutenant", parsetext "<br /><t><img size='7' align='center' image='pics\4.paa'></t>",parseText "<br />",localize "STR_NewRank3"];}
		};
		//playSound "d_fanfare";
		playSound "d_rankup";
	} else {
...
if (_score < d_points_needed # 4 && {_score >= d_points_needed # 3 && {_d_player_old_rank != 4}}) exitWith {
	if (player getVariable ["d_player_old_score", 0] < d_points_needed # 4) then {
		if (!isStreamFriendlyUIEnabled && {d_force_isstreamfriendlyui != 1}) then {
			...
			call {hint composeText [localize "STR_NewRank1", parsetext "<br />",localize "STR_Captain", parsetext "<br /><t><img size='7' align='center' image='pics\5.paa'></t>"];}
		};
		//playSound "d_fanfare";
		playSound "d_rankup";
	} else {
...
if (_score < d_points_needed # 5 && {_score >= d_points_needed # 4 && {_d_player_old_rank != 5}}) exitWith {
	if (player getVariable ["d_player_old_score", 0] < d_points_needed # 5) then {
		if (!isStreamFriendlyUIEnabled && {d_force_isstreamfriendlyui != 1}) then {
			...
			call {hint composeText [localize "STR_NewRank1", parsetext "<br />",localize "STR_Major", parsetext "<br /><t><img size='7' align='center' image='pics\6.paa'></t>"];}
		};
		//playSound "d_fanfare";
		playSound "d_rankup";
	} else {
...
if (_score < d_points_needed # 6 && {_score >= d_points_needed # 5 && {_d_player_old_rank != 6}}) exitWith {
	if (player getVariable ["d_player_old_score", 0] < d_points_needed # 6) then {
		if (!isStreamFriendlyUIEnabled && {d_force_isstreamfriendlyui != 1}) then {
			...
			call {hint composeText [localize "STR_NewRank1", parsetext "<br />",localize "STR_Colonel", parsetext "<br /><t><img size='7' align='center' image='pics\7.paa'></t>"];}
		};
		//playSound "d_fanfare";
		playSound "d_rankup";
	} else {
...
if (_score >= d_points_needed # 6 && {_d_player_old_rank != 7}) exitWith {
	...
	if (!isStreamFriendlyUIEnabled && {d_force_isstreamfriendlyui != 1}) then {
		...
		call {hint composeText [localize "STR_NewRank1", parsetext "<br />",localize "STR_General", parsetext "<br /><t><img size='7' align='center' image='pics\8.paa'></t>"];}
	};
	//playSound "d_fanfare";
	playSound "d_rankup";
	player setVariable ["d_player_old_score", _score];
