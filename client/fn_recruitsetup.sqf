...
//		case opfor: {["O_R_recon_AR_F", "O_R_recon_LAT_F", "rhs_vdv_recon_arifleman", "rhs_vdv_engineer", "O_R_soldier_exp_F", "O_R_recon_M_F", "rhs_vdv_recon_medic", "rhs_vdv_aa", "FP_Spetsnaz_Alpha_Heli_Pilot", "rhs_pilot", "rhs_vdv_flora_crew_commander", "rhs_vdv_mflora_armoredcrew"]};
		case opfor: {["min_rf_recon_saboteur", "min_rf_recon_LAT", "rhs_vdv_recon_arifleman", "min_rf_soldier_repair", "O_R_soldier_exp_F", "O_R_recon_M_F", "min_rf_recon_medic", "min_rf_soldier_AA", "min_rf_helipilot", "rhs_pilot", "rhs_vdv_flora_crew_commander", "rhs_vdv_mflora_armoredcrew"]};
		case independent: {[]};
	};
#endif
#ifdef __GMCWG__
