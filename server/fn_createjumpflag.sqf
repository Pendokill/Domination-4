...
if (_posi isNotEqualTo []) then {
	...
	[format ["d_paraflag%1", count d_resolved_targets], _flag, "ICON", "ColorYellow", [0.5, 0.5], ["Vehicle", localize "STR_DOM_MISSIONSTRING_1266a"] select (d_jumpflag_vec isEqualTo ""), 0, "mil_flag"] call d_fnc_CreateMarkerGlobal;
