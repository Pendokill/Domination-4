...
switch (d_own_side) do {
	...
	case "WEST": {["B_D_APC_Tracked_01_aa_lxWS","B_D_APC_Wheeled_01_cannon_lxWS","B_D_APC_Wheeled_01_atgm_lxWS","B_D_APC_Tracked_01_rcws_lxWS","B_D_Heli_Light_01_dynamicLoadout_lxWS","B_D_Heli_Attack_01_dynamicLoadout_lxWS","B_D_Plane_CAS_01_dynamicLoadout_lxWS","B_D_MBT_01_cannon_lxWS","B_D_MBT_01_TUSK_lxWS","B_MBT_03_cannon_lxWS"]};
