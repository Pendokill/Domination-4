...
d_functionary = "CSLA_CIV_Functionary_V2";
...
d_sm_deliver_truck = switch (d_enemy_side_short) do {
	...
	case "W": {["CSLA_V3Sr", "CSLA_V3Sa", "CSLA_V3Sf", "CSLA_OZV90"]};
